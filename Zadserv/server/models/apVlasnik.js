...
const apVlasnik = new Schema({
	...
	Ime: {
		type: String,
		required: [true, 'Ime vlasnika je obavezno !!!']
	},
	Adresa: {
		type: String,
		required: [true, 'Adresa vlasnika je obavezna !!!'],
		trim: true
	},
	Glavni: {
		type: Boolean,
	...
	Mesto: {
		type: String,
		required: [true, 'Mesto vlasnika je obavezno !!!'],
		trim: true
	},
	PttReon: {
		type: String,
